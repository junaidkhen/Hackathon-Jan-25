...
const contact = () => {
  return (
    <div className="w-[1428px] h-[1230px] absolute top-[144px] left-[6px]  text-[16px] font-normal leading-[28px] border-[1px] border-transparent hover:border-[1px] hover:border-black">
      {/* Search Help */}
